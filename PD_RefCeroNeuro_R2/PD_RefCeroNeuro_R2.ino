...
double PID_R() {
  ...
  double output = Kp * error + Kd * rateError + (utpp * 15) ;  //+ Ki * cumError;  // calcular la salida del PID
...
double PID_L() {
  ...
  double output = Kp * errorL + Kd * rateErrorL + (utpp * 15) ;  //+ Ki * cumErrorL;  // calcular la salida del PID
